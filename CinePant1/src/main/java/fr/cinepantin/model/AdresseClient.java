...
public class AdresseClient implements Serializable {
	...
	public AdresseClient(Long adresseClientId, String nomRue, String ville, String pays, String codePostal) {
		super();
	...
	public String toString() {
		return "AdresseClient [adresseClientId=" + adresseClientId +
				", nomRue=" + nomRue + ", ville=" + ville
				+ ", pays=" + pays + ", codePostal=" + codePostal + "]";
	}
